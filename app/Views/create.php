<?php $this->layout('layout', ['title' => 'Добавить пользователя']) ?>
            ...
            <div id="panel-1" class="panel">
                <div class="panel-container">
                    ...
                    <div class="panel-content">
                        ...
                        <!-- Role-->
                        <div class="form-group">
                            <label class="form-label" for="simpleinput">Роль</label>
                            <select class="form-control" id="example-select" name="roles_mask">
                                <option value="0" selected>Простой пользователь</option>
            ...
            <div id="panel-1" class="panel">
                <div class="panel-container">
                    ...
                    <div class="panel-content">
                        ...
                        <!-- password again -->
                        <div class="form-group">
                            <label class="form-label" for="simpleinput">Повторите пароль</label>
